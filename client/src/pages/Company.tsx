    ...
    <SiteFrame>
      ...
      <section className="sub-layout">
        ...
        <article className="sub-content greeting-content">
          <p className="content-kicker">ㅇㅇ토건</p>
          <h2>현장을 먼저 이해하고,<br /><em>공정의 기준</em>을 세웁니다.</h2>
          <div className="greeting-content__line" />
          <p>ㅇㅇ토건은 토목·건축 공사와 외부 시설물의 시공·정비 흐름을 명확하게 안내하기 위해 만든 예시 브랜드입니다. 실제 사업 정보로 교체하기 전, 고객이 문의부터 현장 확인까지 자연스럽게 이동할 수 있는 페이지 구조를 보여 줍니다.</p>
          ...
          <div className="company-signoff"><span>ㅇㅇ토건 드림</span><b>ㅇㅇ<br />토건</b></div>
